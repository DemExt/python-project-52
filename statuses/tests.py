...
class StatusCRUDTest(TestCase):
    def setUp(self):
        ...
        self.list_url = reverse("statuses:index")
        self.create_url = reverse("statuses:create")
        self.update_url = reverse("statuses:update", args=[self.status.id])
        self.delete_url = reverse("statuses:delete", args=[self.status.id])
